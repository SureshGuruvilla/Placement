    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child(key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                detailName.setText(Html.fromHtml("<b>Name : </b>")+dataSnapshot.child("NAME").getValue(String.class));
                detailDOB.setText(Html.fromHtml("<b>Date Of Birth : </b>")+dataSnapshot.child("DOB").getValue(String.class));
                ...
                detailDept.setText(Html.fromHtml("<b>Department : </b>")+dataSnapshot.child("DEPT").getValue(String.class));
                detailRegno.setText(Html.fromHtml("<b>Register No : </b>")+dataSnapshot.child("REGNO").getValue(String.class));
                detailEmail.setText(Html.fromHtml("<b>E Mail : </b>")+dataSnapshot.child("EMAILID").getValue(String.class));
                detailPhone.setText(Html.fromHtml("<b>Phone Number: </b>")+dataSnapshot.child("PHONENO").getValue(String.class));
                detailTM.setText(Html.fromHtml("<b>Tenth Percentage : </b>")+dataSnapshot.child("TM").getValue(String.class));
                detailTWM.setText(Html.fromHtml("<b>Twelth Percentage : </b>")+dataSnapshot.child("TWM").getValue(String.class));
                detailCGPA.setText(Html.fromHtml("<b>CGPA : </b>")+dataSnapshot.child("CGPA").getValue(String.class));
                detailSA.setText(Html.fromHtml("<b>Standing Arrears : </b>")+dataSnapshot.child("SA").getValue(String.class));
                detailHOA.setText(Html.fromHtml("<b>History of Arrerars : </b>")+dataSnapshot.child("HOA").getValue(String.class));
                if(dataSnapshot.child("HOD").getValue(String.class)=="H"){
