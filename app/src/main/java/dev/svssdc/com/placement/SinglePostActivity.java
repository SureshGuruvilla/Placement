    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child(s_typeposts).child(s_post).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                singleName.setText(dataSnapshot.child("name").getValue(String.class));
                singleDesc.setText(dataSnapshot.child("desc").getValue(String.class));
                singleTime.setText(dataSnapshot.child("time").getValue(String.class));
                if(dataSnapshot.hasChild("image")){
                Picasso.with(getApplicationContext()).load(dataSnapshot.child("image").getValue(String.class)).
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(getApplicationContext()).load(dataSnapshot.child("image").getValue(String.class)).into(singleImage);
                    }
                });
                }
                Picasso.with(getApplicationContext()).load(dataSnapshot.child("dp").getValue(String.class)).networkPolicy(NetworkPolicy.OFFLINE).into(singleDp, new com.squareup.picasso.Callback() {
                    @Override
                    public void onSuccess() {
                    }
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(getApplicationContext()).load(dataSnapshot.child("dp").getValue(String.class)).into(singleDp);
                    }
                });
            }
