...
//                String i;
//                int n = 0;
//                for(i="722015114001"; n<179; n++){
//                    final String finalI = i;
//                    firebaseAuth.createUserWithEmailAndPassword("SVS"+i+"@gmail.com",i).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
//                        @Override
//                        public void onComplete(@NonNull Task<AuthResult> task) {
//                            if(task.isSuccessful()){
//                                Toast.makeText(getApplicationContext(), finalI +"created succesfully",Toast.LENGTH_SHORT).show();
//                            }
//                            else {
...
//                        }
//                    });
//                    i=String.valueOf(Long.parseLong(i)+1);
//                }
