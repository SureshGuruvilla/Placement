    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child(firebaseAuth.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                editPhone.setText(dataSnapshot.child("Phoneno").getValue(String.class));
                editFrom.setText(dataSnapshot.child("from").getValue(String.class));
                editSchool.setText(dataSnapshot.child("school").getValue(String.class));

                editTextName.setText(dataSnapshot.child("Name").getValue(String.class));
                editTextDob.setText(dataSnapshot.child("Dob").getValue(String.class));
                editTextPhine.setText(dataSnapshot.child("Phoneno").getValue(String.class));
                editTextFrom.setText(dataSnapshot.child("from").getValue(String.class));
                editTextSchool.setText(dataSnapshot.child("school").getValue(String.class));
                Picasso.with(getApplicationContext()).load(dataSnapshot.child("Image").getValue(String.class)).into(editDp);
            }
            @Override
