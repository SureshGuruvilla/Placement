...
//    private PagerAdapter pagerAdapter;
        ...
        try{
            ...
            logindatabasereference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(final DataSnapshot dataSnapshot) {
                    name.setText(dataSnapshot.child(mainFirebaseAuth.getUid()).child("Name").getValue(String.class));
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data : dataSnapshot.getChildren()){
                    if(data.hasChild(mainFirebaseAuth.getUid())){
                    }
                    else {
                        count[0]++;
                    }
                ...
                if(count[0] >0){
                    tv.setText(String.valueOf(count[0]));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.search:{
                startActivity(new Intent(MainActivity.this,SearchActivity.class));finish();
                break;
            }
            case R.id.about:{
                startActivity(new Intent(MainActivity.this,AboutUsActivity.class));finish();
                break;
            }
            case R.id.svs:{
                startActivity(new Intent(MainActivity.this,SvsceActivity.class));finish();
                break;
            }
            case R.id.contact:{
                startActivity(new Intent(MainActivity.this,ContactActivity.class));finish();
                break;
            }
            case R.id.feedback:{
                startActivity(new Intent(MainActivity.this,FeedbackActivity.class));finish();
                break;
            }
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
